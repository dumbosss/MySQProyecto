<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmLibro.aspx.cs" Inherits="MySQProyecto.Capa_Negocio.frmLibro" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <p>
                ...
                <asp:Button Text="Listar" runat="server" ID="btnListar" />
